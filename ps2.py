...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        if current_tile not in self.clean_tiles:
            self.clean_tiles.append(current_tile)
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        self.position = Position(math.floor(random.randint(0, room.width - 1)), math.floor(random.randint(0, room.height-1)))
        self.direction = random.random() * 360 #angles
...
#                anim.update(room, robots)
        ...
        mean_time_steps.append(total_time_steps)
#        anim.done()
        
    return sum(mean_time_steps) / num_trials
    
    
#print(runSimulation(2, 1.0, 8, 8, 0.8, 1, StandardRobot))
